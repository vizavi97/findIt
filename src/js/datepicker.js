  ...
  var b = function () {
    ...
    return n(e, [{
      ...
      key: "_onmousedown", value: function (e) {
        var t = this, n = this._opts, i = n.ranged, r = n.multiple, d = n.classNames, u = d.selected, c = d.highlighted,
          p = s(e.target, "[data-day]", this.wrapper), f = p ? parseInt(p.dataset.day, 10) : null;
      ...
      key: "show", value: function () {
        if (!this._opts.inline) {
          ...
          var e = this.node.getBoundingClientRect(), t = this._el.getBoundingClientRect(), n = t.bottom - e.top + "px",
            i = e.bottom - t.top + "px";
      ...
      key: "getDate", value: function () {
        var e = this._opts, t = e.ranged, n = e.multiple, i = e.time, a = this._time ? this._time.start : [0, 0];
      ...
      key: "getData", value: function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0, t = this._opts, n = t.i18n,
          i = t.weekStart, a = t.serialize, r = t.min, s = t.max, o = t.classNames, l = o.selected, h = o.disabled,
          u = o.otherMonth, c = o.weekend, p = o.today, g = new Date(this._month.getTime());
